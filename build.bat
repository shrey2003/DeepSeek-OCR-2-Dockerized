...
if not exist "models" (
    ...
    echo    Run: huggingface-cli download deepseek-ai/DeepSeek-OCR-2 --local-dir models\deepseek-ai/DeepSeek-OCR
    echo.
)
...
if not exist "models\deepseek-ai\DeepSeek-OCR\config.json" (
    ...
    echo    huggingface-cli download deepseek-ai/DeepSeek-OCR-2 --local-dir models\deepseek-ai\DeepSeek-OCR
    echo.
    pause
    exit /b 1
)
